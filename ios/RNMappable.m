...
RCT_EXPORT_METHOD(init: (NSString *) apiKey
    ...
    @try {
        ...
        reject(exception.name, exception.reason ?: @"Error initiating MMKMapKit", error);
    }
}
