...
import { MappableMap } from './Mappable';
...
const MappableMapNativeComponent = requireNativeComponent<Omit<ClusteredMappableMapProps, 'clusteredMarkers'> & {clusteredMarkers: Point[]}>('ClusteredMappableView');

export class ClusteredMappable extends React.Component<ClusteredMappableMapProps> {
  static defaultProps = {
  ...
  private getCommand(cmd: string): any {
    return Platform.OS === 'ios' ? UIManager.getViewManagerConfig('ClusteredMappableView').Commands[cmd] : cmd;
  }
  ...
  private getProps() {
    ...
    processColorProps(props, 'clusterColor' as keyof ClusteredMappableMapProps);
    processColorProps(props, 'userLocationAccuracyFillColor' as keyof ClusteredMappableMapProps);
    processColorProps(props, 'userLocationAccuracyStrokeColor' as keyof ClusteredMappableMapProps);
